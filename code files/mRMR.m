...
for i = 1:10
    ...
    %Store weights
    save(sprintf('s%d_mRMR_weights.mat', i), 'weights');
end
%% Loading mRMR weights for each subject
addpath 'C:\Users\daniyar.zhakyp\Documents\MATLAB\Capstone\mRMR'
subjects_weights = cell(10,1);
for i = 1:10
    subjects_weights{i} = load(sprintf('s%d_mRMR_weights.mat', i)).weights;
end
...
save("mRMR_top5_acc",'subject_accuracies');
save("mRMR_top5_f1",'subject_f1');
