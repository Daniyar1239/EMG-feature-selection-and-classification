...
for i = 1:10
    ...
    %Store weights
    save(sprintf('s%d_chi2_weights.mat', i), 'weights');
end
%%
addpath 'C:\Users\daniyar.zhakyp\Documents\MATLAB\Capstone\chi2'
subjects_weights = cell(10,1);
for i = 1:10
    subjects_weights{i} = load(sprintf('s%d_chi2_weights.mat', i)).weights;
end
...
save("chi2_top5_acc",'subject_accuracies');
save("chi2_top5_f1",'subject_f1');
